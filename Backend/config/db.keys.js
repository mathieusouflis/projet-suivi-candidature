const dbKeys = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'default-jwt-secret-do-not-use-in-production',
  sessionSecret: process.env.SESSION_SECRET || 'default-session-secret-do-not-use-in-production',
...
if (process.env.NODE_ENV === 'production') {
  if (
    ...
    console.error('Please set JWT_SECRET and SESSION_SECRET environment variables');
    process.exit(1);
  }
}
