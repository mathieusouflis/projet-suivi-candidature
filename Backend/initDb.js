...
const initializeDatabase = async () => {
  try {
    ...
    if (config.environment !== 'development') {
      logger.info('Initialisation de la base de données ignorée en environnement non-développement');
      return;
    }
    
    logger.info('Début de l\'initialisation de la base de données avec des données de test...');
