...
const JobPage = () => {
  ...
  const [descriptionTimeout, setDescriptionTimeout] =
    useState<NodeJS.Timeout | null>(null);
  const [companyTimeout, setCompanyTimeout] = useState<NodeJS.Timeout | null>(
    null
  );
  ...
  const [salaryTimeout, setSalaryTimeout] = useState<NodeJS.Timeout | null>(
    null
  );
  ...
  const handleChangements = (
    e:
      | React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
      | { target: { value: string } },
    valueTimeout: any,
    setTimeoutEffect: any,
    key: keyof Job
  ): void => {
    ...
    <>
      <div className="flex flex-row h-full max-h-full w-full">
        <div className="w-full flex flex-col gap-3 p-4">
          <TypographyH1>{job?.title || "No jobs"}</TypographyH1>
          <Textarea
            className="resize-none h-full"
            placeholder="Job description"
            defaultValue={job?.description || "No description"}
            onChange={(e) =>
              handleChangements(
                e,
                descriptionTimeout,
        ...
        <div className="p-4 w-sm flex flex-col gap-3">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleChangements(e, titleTimeout, setTitleTimeout, "title")
              }
            />
          </div>
          <div>
              ...
              <Popover>
                <PopoverTrigger>
                  ...
                  >
                    ...
                    {job?.datePostulation ? (
                      format(job?.datePostulation, "PPP")
                    ) : (
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleChangements(e, linkTimeout, setLinkTimeout, "link")
              }
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleChangements(e, salaryTimeout, setSalaryTimeout, "salary")
              }
            />
          </div>
        </div>
